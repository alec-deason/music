...
mod plan {
    ...
    fn smooth_progression(key: &Key, leadin_chord: &Chord, count: u32, augmentation_prob: f64) -> ChordProgression {
...
pub fn main() {
    ...
    let mut sig = ((melody_voice + melody_voice2 * 1.0) * 0.8 + (bass * 1.0 + pads * 0.0) * 0.5) * 1.0;
